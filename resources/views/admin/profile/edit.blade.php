            ...
            <div class="col-md-8 mx-auto">
                ...
                <form action="{{ route('admin.profile.update') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                          　<label>男性</label><input class="form-control-radio" type="radio" name="gender" value="{{ $profiles_form->gender }}">
                          　<label>女性</label><input class="form-control-radio" type="radio" name="gender" value="{{ $profiles_form->gender }}">
                          　<label>その他</label><input class="form-control-radio" type="radio" name="gender" value="{{ $profiles_form->gender }}">
                        </div>
                    </div>
                    <div class="form-group row">
